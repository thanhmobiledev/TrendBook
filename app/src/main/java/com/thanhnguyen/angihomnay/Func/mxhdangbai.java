...
public class mxhdangbai extends AppCompatActivity implements View.OnClickListener {
...
//
    ...
    public  void HienThi()
    {
        ...
        adapter= new QLDanhGiaAdapter(mxhdangbai.this, R.layout.customhtdanhgia, arrayList);
    ...
    private void addBan() {
        mData.child(manh).child("DanhGia").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                //oast.makeText(mxhdangbai.this, key, Toast.LENGTH_SHORT).show();
                    ...
                    {
                        Toast.makeText(mxhdangbai.this, ex.toString(), Toast.LENGTH_LONG).show();
                    }
            ...
            if(resultCode == Activity.RESULT_OK && data !=null){
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        Toast.makeText(mxhdangbai.this, "Loi upload hinh", Toast.LENGTH_SHORT).show();
                    }
        ...
        switch (id) {
            ...
            case R.id.btndanhcmngia:
            {
                ...
                else
                {
                    ...
                    Intent i = new Intent(mxhdangbai.this, mxh.class);
                    startActivity(i);
                }
